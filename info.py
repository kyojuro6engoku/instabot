...
API_ID = int(os.environ.get('API_ID', '827908943'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001717634274').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jaganvinod123:jaganvinod123@cluster0.p6afdpp.mongodb.net/?retryWrites=true&w=majority")
...
FILE_FORWARD = environ.get('FILE_FORWARD',"-1001717634274")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001958970727'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001788341105'))
